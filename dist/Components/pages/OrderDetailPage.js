...
var OrderDetailPage = /** @class */ (function (_super) {
    ...
    OrderDetailPage.prototype.template = function () {
    ...
    OrderDetailPage.prototype.afterRender = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, data_1, personalIn4, productIn4, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        productSearch();

...
var CategoryEdit = /** @class */ (function (_super) {
    ...
    CategoryEdit.prototype.template = function () {
    ...
    CategoryEdit.prototype.afterRender = function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        user = new Category(0, name);
                                        return [4 /*yield*/, CategoryApi.update(this._id, user)];
                                    case 1:
                                        _a.sent();
